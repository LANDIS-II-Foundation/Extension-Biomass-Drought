...
#define ExtensionName "Drought Generator"
...
Source: {#BuildDir}\Landis.Extension.DroughtGenerator-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Drought Generator Component 2.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Drought Generator"" "; WorkingDir: {#LandisPlugInDir}
