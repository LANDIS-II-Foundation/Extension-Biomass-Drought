...
#define ExtensionName "Drought Disturbance"
...
AppId={{9E3DD209-63D7-4B3B-8A14-C2E12154CF94}}
...
Source: {#BuildDir}\Landis.Extension.DroughtDisturbance-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Drought Disturbance Component 2.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Drought Disturbance"" "; WorkingDir: {#LandisPlugInDir}
